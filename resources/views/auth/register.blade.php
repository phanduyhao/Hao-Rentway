...
@section('content')
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<h2 class="ipt-title">{{ __('common.register_account') }}</h2>
							<span class="ipn-subtitle">{{ __('common.register_now') }}!</span>
							...
							<div class="card border-0 rounded-4 p-xl-4 p-lg-4 p-md-4 p-3">
								...
								<div class="simple-form">
									<div class="form-header text-center mb-5">
										...
										<h4 class="fs-2">{{ __('common.register_account') }}</h4>
									</div>
									<form id="form-register" method="POST" action="{{ route('register') }}">
										...
										<div class="row">
											...
											<div class="col-lg-6 col-12">
												<div class="form-group mb-3">
													<label>{{ __('common.full_name') }}<span class="text-danger ms-1">*</span></label>
													<input type="text" name="name" class="form-control" placeholder="{{ __('common.full_name') }}" value="{{ old('name') }}">
											...
											<div class="col-lg-6 col-12">
												<div class="form-group mb-3">
													<label>Username <span class="text-danger ms-1">*</span></label>
											...
											<div class="col-lg-6 col-12">
												<div class="form-group mb-3">
													...
													<input type="tel" name="phone" class="form-control" placeholder="098XXXXXXX" value="{{ old('phone') }}">
											...
											<div class="col-lg-6 col-12 ">
												<div class="form-group mb-3">
													...
													<input type="text" name="telegram" class="form-control" placeholder="@username/098XXXXXXX" value="{{ old('telegram') }}">
											...
											<div class="col-lg-6 col-12 ">
												<div class="form-group mb-3">
													<label> Zalo</label>
													<input type="text" name="zalo" class="form-control" placeholder="098XXXXXXX" value="{{ old('zalo') }}">
													@error('zalo') <small class="text-danger">{{ $message }}</small> @enderror
												</div>
											</div>
											{{-- <div class="form-group col-12 mb-5">
												<label>{{ __('common.nationality') }}</label>
												<select id="quoctich" class="form-control" name="quoctich">
													<option value="">{{ __('common.select_nationality') }}</option>
												</select>
												@error('quoctich') <small class="text-danger">{{ $message }}</small> @enderror
											</div> --}}
											<!-- Mật khẩu -->
											<div class="col-lg-6 col-12 ">
												<div class="form-group mb-3">
													<label>{{ __('common.password') }} <span class="text-danger ms-1">*</span></label>
											...
											<div class="col-lg-6 col-12 ">
												<div class="form-group mb-3">
													<label>{{ __('common.confirm_password') }} <span class="text-danger ms-1">*</span></label>
											...
											<div class="col-12 ">
												<div>
													<label>{{ __('common.account_type') }}</label>
													<select id="role" class="form-control" name="role">
														<option value="user">{{ __('common.guest') }} </option>
														<option value="chunha">{{ __('common.landlord') }}</option>
														<option value="moigioi">{{ __('common.agent') }}</option>
														<option value="nhanvien">{{ __('common.staff') }}</option>
													</select>
												</div>
											</div>
										</div>
										...
										<div class="form-group mt-5">
											<button type="submit" class="btn btn-primary full-width fw-medium">
												{{ __('common.register_account') }} <i class="fa-solid fa-arrow-right-long ms-2"></i>
											</button>
										</div>
									</form>
									
									<div>
									<a href="{{ route('showLogin') }}" class="link fw-medium">{{ __('common.already_have_account') }}</a>	
									</div>
								</div>
    ...
    // Lấy giá trị ngôn ngữ từ sessionStorage
    var language = sessionStorage.getItem('selected_language');

    // Nếu có giá trị ngôn ngữ trong sessionStorage, gán nó vào input hidden
    if (language) {
        // Tìm thẻ input có name="language" và gán giá trị
