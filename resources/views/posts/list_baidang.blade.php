                        ...
                        <div class="sidebar-widgets">
                            ...
                            <div class="search-inner p-0">
                                ...
                                <div class="filter-search-box">
                                    <form method="get" method="GET" action="{{ route('posts.list') }}"
                                        class="form-group">
                                        @csrf
                                ...
                                <div class="property-listing list_view style_new row mx-auto">
                                    <div class="col-md-6 col-12">
                                        <div class="listing-img-wrapper position-relative">
                                            ...
                                            <div class="position-absolute top-0 end-0 me-3 mt-3 z-1 d-flex flex-column">
                                                <div
                                                ...
                                                @if (Auth::check() && (Auth::user()->role == 'admin' || Auth::user()->role == 'nhanvien'))
                                                    <div
                                                        class="label bg-success text-light d-inline-flex align-items-center justify-content-center mt-2">
                                                        <span class="svg-icon fw-bold ght svg-icon-2hx me-1">
                                                            {{ __('post.broker') }}: {{ $item->mamoigioi }}
                                                        </span>
                                                    </div>
                                                @endif
                                            </div>
                                                ...
                                                <div class="clior">
                                                    @foreach (json_decode($item->images, true) ?? [] as $image)
                                                        <div><a href="{{ route('baidangDetail', $item->slug) }}"><img
                                                                    src="{{ $image }}"
                                                                    class="img-fluid mx-auto img-custom rounded-4"
                                                                    alt="" /></a></div>
                                                    @endforeach
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="listing-card d-flex align-items-center">
                                                        <div class="square--30 text-muted-2 fs-sm circle gray-simple me-2">
                                                            <img src="/temp/assets/img/bed.svg" width="20"
                                                                alt="">
                                                        </div><span class="text-muted-2">{{ $item->bedrooms }} Phòng
                                                            ngủ</span>
                                                    </div>
                                                    <div class="listing-card d-flex align-items-center">
                                                        <div class="square--30 text-muted-2 fs-sm circle gray-simple me-2">
                                                            <img src="/temp/assets/img/bathtub.svg" width="20"
                                                                alt="">
                                                        </div><span class="text-muted-2">{{ $item->bathrooms }} Phòng
                                                            tắm</span>
                                                    </div>
                                                    <div class="listing-card d-flex align-items-center">
                                                        <div class="square--30 text-muted-2 fs-sm circle gray-simple me-2">
