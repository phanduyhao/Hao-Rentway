    ...
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="footer-widget">
                        <h4 class="widget-title">{{ __('common.model') }}</h4>
                        @php
                            $models = [
                                'ban' => 'sale',
                                'thue' => 'rent',
                        ...
                        <ul class="footer-menu">
                            @foreach ($models as $slug => $key)
                                <li class="{{ request('mohinh') === $slug ? 'active' : '' }}">
                                    <a href="{{ route('posts.list', ['mohinh' => $slug]) }}">
                                        {{ __('common.model.' . $key) }}
                                    </a>
                                </li>
                            @endforeach
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="footer-widget">
                        <h4 class="widget-title">{{ __('common.property_type') }}</h4>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <p class="mb-0">© 2025 copyright rentway68.com</p>
                </div>

                <div class="col-lg-6 col-md-6 text-right">
                    <ul class="footer-bottom-social">
                        <li><a href="{{ $settings['link_fb'] }}"><i class="fa-brands fa-facebook"></i></a></li>
                        <li><a href="{{ $settings['link_telegram'] }}"><i class="fa-brands fa-telegram"></i></a></li>
                    </ul>
                </div>
